...
fluxes = %s
errors = %s
uplims = %s #Assuming detections, not upper limits
...
galaxy_parameters = {
    ...
    'age'      : ( [6., 11.], True ),
    'redshift' : %7.4f,     # ( [0., 10.], False ), # fix redshift value
...
for index, row in df.iterrows():
    ...
    filename = f"galapy_hyper_parameter_{int(galaxy_id)}_delayedexp_dynesty.py"

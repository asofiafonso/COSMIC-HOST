# Galapy Hyper Parameter File for Galaxy 56700000
...
fluxes = [0.2870782801031357, 0.2649722407685952, 0.2563302707452593, 0.3188597497591953,0.2644843961386838, 0.6286374771434995, 0.7392643162962484, 0.8879740384221213 ]
errors = [0.0264408871255138, 0.0244048456297004, 0.0236088907638463, 0.0293680686996717, 0.0243599134781296, 0.0578996522134923, 0.0680887607940486, 0.0817854325721578]
uplims = [False, False, False, False, False, False, False, False] #Assuming detections, not upper limits
...
#
# filters = ['SDSS.g', 'SDSS.r', 'SDSS.i', 'SDSS.z', 'Euclid.VIS', 'Euclid.Y', 'Euclid.J', 'Euclid.H' ]
#
...
galaxy_parameters = {
    ...
    'age'      : ( [6., 11.], True ),
    'redshift' :  0.0233,     # ( [0., 10.], False ), # fix redshift value
